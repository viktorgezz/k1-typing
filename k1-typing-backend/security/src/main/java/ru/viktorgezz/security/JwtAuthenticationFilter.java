...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            final String usernameExtract = jwtService.extractUsername(tokenAccess);

            if (usernameExtract != null) {
                final UserDetails userDetails = userDetailsService.loadUserByUsername(usernameExtract);

                if (jwtService.validateToken(tokenAccess, userDetails.getUsername(), usernameExtract)) {
                    ...
                    log.debug("User '{}' authenticated successfully.", usernameExtract);
                }
            }
