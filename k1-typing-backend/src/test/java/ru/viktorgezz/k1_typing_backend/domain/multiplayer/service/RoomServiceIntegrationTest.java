...
import static ru.viktorgezz.k1_typing_backend.domain.multiplayer.redis.utility.RedisKeyGenerator.FIELD_EXERCISE_ID;
import static ru.viktorgezz.k1_typing_backend.domain.multiplayer.redis.utility.RedisKeyGenerator.FIELD_MAX_PARTICIPANTS;
import static ru.viktorgezz.k1_typing_backend.domain.multiplayer.redis.utility.RedisKeyGenerator.keyFinishers;
import static ru.viktorgezz.k1_typing_backend.domain.multiplayer.redis.utility.RedisKeyGenerator.keyInfo;
