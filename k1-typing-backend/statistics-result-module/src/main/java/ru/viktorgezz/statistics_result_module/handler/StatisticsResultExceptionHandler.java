package ru.viktorgezz.statistics_result_module.handler;
...
import ru.viktorgezz.statistics_result_module.exception.BusinessException;
import ru.viktorgezz.statistics_result_module.exception.ErrorCode;
 ...
 */
@RestControllerAdvice(basePackages = "ru.viktorgezz.statistics_result_module")
@Slf4j
public class StatisticsResultExceptionHandler {
