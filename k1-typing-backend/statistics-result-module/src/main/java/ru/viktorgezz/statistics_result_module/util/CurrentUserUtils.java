package ru.viktorgezz.statistics_result_module.util;
...
import ru.viktorgezz.statistics_result_module.exception.KeyLoadingException;
...
public class CurrentUserUtils {
    ...
    public static Long getIdUserNullable() {
        final String token = extractToken();
        final Claims claims = parseToken(token);
